...
<!--                            -->
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">{{Session::get('price')}} MEX</strong></div>
                    </div>
                    @else
                    <div class="order-col">
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            <p>El producto se entregará dentro de las 24 horas posteriores a la confirmación. Solo aceptamos Pago contra reembolso en este momento.</p>
                        </div>
                    </div>
                </div>
                @if(session('user'))
                   ...
                   <center> <form method="post" name="cart">
                        {{csrf_field()}}
                        <input type="submit" id="confirm_order"  name="order" class="primary-btn order-submit" value="Confirmar pedido">
                    </form></center>

                    @else
                        <a href="{{route('user.home')}}"><input type="button"  class="primary-btn order-submit" value="Ordenar ahora"></a>
                    @endif
            ...
            <div class="col-md-7">
                ...
                <div class="billing-details">
                    ...
                    <div class="form-group">
                        <input class="input" type="text" id="name" name="name" placeholder="Nombre completo">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input class="input" type="text" name="address" id="address" placeholder="Dirección">
                    </div>
                    <div class="form-group">
                        <input class="input" type="text" name="city" id="city" placeholder="Ciudad">
                    </div>
                    <div class="form-group">
                        <input class="input" type="text" name="zip" id="zip" placeholder="Codigo poltal">
                    </div>
                    <div class="form-group">
                        <input class="input" type="tel" name="tel" id="tel" placeholder="Telefono">
                    </div>
                    <div class="form-group">
                        <input class="input" type="password" name="pass" id="pass" placeholder="Ingresa tu contraseña">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="submit"  name="signup" class="primary-btn order-submit" value="Regístrate">
...
<script>
   ...
   //TO DO: ajax will take place
    ...
    $.ajax({
            ...
            {
                document.getElementById("individualPrice_"+order_serial).innerHTML=x*product_price+" MEX";
                document.getElementById("totalCost").innerHTML = msg[2]+" MEX";
            }
            });
    ...
    $(document).ready(function() {
		...
		$("#signupForm").validate({
			...
			messages: {
                ...
                address: "Por favor ingrese su direccion",
                ...
                tel: "Por favor, introduzca su número de teléfono",
				pass: {
    ...
    var url="{{route('user.signup.check_email')}}";
            ...
            $.ajax({
                ...
                success:function(msg){
                        ...
                        if(msg == "1")
                            {
                                document.getElementById("for_duplicate-email").innerHTML = "<label class='error'>Esta dirección de correo electrónico ya está en uso</label>";
