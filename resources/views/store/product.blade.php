        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div>
                        <h3 class="product-price">MEX {{$product->discount}} <del class="product-old-price">MEX {{$product->price}}</del></h3>
                    ...
                    <div class="add-to-cart">
                        <button type="submit" name="myButton" id="myButton" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Añadir al carrito</button>
                    </div>
                    </form>
...
<script>
    ...
    $(document).ready(function() {
		...
		$("#order_form").validate({
            ...
            document.getElementById("for_error").innerHTML = "<label class='error' style=' '>Entrada de variación no válida</label>";
