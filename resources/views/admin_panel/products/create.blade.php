                                ...
                                < Volver a la lista</a>
                                    ...
                                    <form class="forms-sample" method="post"  id="product_form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Name" name="Nombre"  value="">
                                        </div>
                                        <div class="form-group">
                                            <label  for="Description">Descripción del producto*</label>
                                            <textarea type="textarea" class="form-control" id="Description" name="Descripción"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label  for="Category">Categoria*</label>
                                            <select class="form-control form-control-md" id="Category" name="Categoria">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="Price" id="Precio" value="">
                                        </div>
                                        <div class="form-group">
                                            <label  >Precio con descuento del producto*</label>
                                            <input type="text" class="form-control" id="Discounted_Price"  name="Precio descontado" value="">
                                        </div>
                                        ...
                                        <input type="submit" name="saveButton" class="btn btn-success mr-2" id="saveButton" value="Crear"  />
                                    </form>
                                    @if($errors->any())
